...
//          else {
  ...
  //          }
        ...
        this.joints['all'] = [opts.allJoined]
          .concat(opts.join && Object.values(opts.join['all'] || {}))
          .concat(opts.joints && Object.values(opts.joints || {}))
...
//    console.log(item, i, o.key, key)    
  ...
  addComponent(i, value, extraSources) {
...
//      this['$'+i].destroy()
    ...
    if (!(value instanceof Html)) {
      ...
      const context = extraSources ? {...this.sources, ...extraSources} : this.sources
...
//      return // TODO есть ли ситуация, когда нужно переписать домен?
    ...
    if (/*o.anyChanged ||*/ (o.join && o.join[i]) || o.allJoined || o[i+'Changed'] || o[i+'Joined'] || o.joints) {
...
//      console.log('end initializing', joinedSource)
